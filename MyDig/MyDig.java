...
public class MyDig{
   ...
   static long eTime = 0;
	public static void main(String[] args) {
		...
		System.out.println("Enter the Name and type<separated by a space, type should be in capital letters>");
		Scanner sc = new Scanner(System.in);
		domainName = sc.next();               // First time we take from user
		String typeGiven = sc.next();
		//Input checks
		...
		try{   
				 ...
				 */
			     ...
			     System.out.println("Query Time"+(eTime-sTime)/1000000+"ms");
